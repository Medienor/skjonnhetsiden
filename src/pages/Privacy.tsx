...
const Privacy = () => {
  return (
    <>
      <Helmet>
        <title>Personvernerklæring | Regnskapsførerlisten.no</title>
        <meta 
          name="description" 
        ...
        />
        <meta property="og:title" content="Personvernerklæring - Regnskapsførerlisten.no" />
        <meta 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-blue-900 mb-8">Personvernerklæring</h1>
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold text-blue-800 mb-4">Bruk av personopplysninger</h2>
              <p className="text-gray-600 mb-4">
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold text-blue-800 mb-4">Dine rettigheter</h2>
              <p className="text-gray-600 mb-4">
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold text-blue-800 mb-4">Informasjonskapsler (cookies)</h2>
              <p className="text-gray-600 mb-4">
                Vi bruker informasjonskapsler for å forbedre din brukeropplevelse på våre nettsider. Du kan når som helst endre dine innstillinger for informasjonskapsler i din nettleser.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold text-blue-800 mb-4">Kontakt oss</h2>
              <p className="text-gray-600">
